...
public class PassUserConfirm {
    private AlertDialog dialog;
    private EditText editText;

    private PassUserConfirm(AlertDialog dialog, EditText editText) {
        this.dialog = dialog;
    ...
    public static class Builder {
        ...
        private PassUserConfirm inputDialog; // the proxy dialog
         ...
         * @param listener The {@link PassUserConfirm.ButtonActionListener} to use.
         ...
         * {@link #setOnDismissListener(PassUserConfirm.OnDismissListener)
         * setOnDismissListener}.</p>
         *
         * @return This Builder object to allow for chaining of calls to set methods
         * @see #setCancelable(boolean)
         * @see #setOnDismissListener(PassUserConfirm.OnDismissListener)
         */
         ...
         *
         * @param intercepter The {@link PassUserConfirm.ButtonActionIntercepter} to use.
         * @return This Builder object to allow for chaining of calls to set methods
         */
        ...
        /**
         * Creates a {@link PassUserConfirm} with the arguments supplied to this builder and
         * {@link Dialog#show()}'s the dialog.
         */
        public PassUserConfirm show() {
            initLayout();
        ...
        /**
         * Creates a {@link PassUserConfirm} with the arguments supplied to this builder. It does not
         * {@link Dialog#show()} the dialog. This allows the user to do any extra processing
         * before displaying the dialog. Use {@link #show()} if you don't have any other processing
         * to do and want this to be created and displayed.
         */
        public PassUserConfirm create() {
            initLayout();
        ...
        private void initLayout() {
            if (customizedLayoutResId == 0) {
                builder.setView(R.layout.confirm_user_pass);
            } else {
        ...
        private PassUserConfirm createInputDialog(AlertDialog dialog) {
            inputDialog = new PassUserConfirm(dialog, obtainEditText(dialog));
            return inputDialog;
        }

        private EditText obtainEditText(AlertDialog dialog) {
            if (editTextId == 0) {
                return (EditText) dialog.findViewById(R.id.reenter_pass);
            } else {
